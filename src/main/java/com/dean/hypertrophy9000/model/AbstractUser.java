...
public class AbstractUser {
    ...
    public AbstractUser(String username, Boolean isMetricUser, int age, double heightCm, double weightKg, double neckSizeCm, double waistSizeCm, double hipSizeCm, ActivityLevel activityLevel, Sex sex) {
